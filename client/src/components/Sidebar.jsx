...
//   const { role } = useSelector((state) => state.user); // Access role from Redux store
...
//               }
//             >
//               <span className="mr-3">{getIconComponent('AiOutlineWallet')}</span>
//               <span>Parties</span>
//             </NavLink>
//           </div>
//         </li>
...
//               }
//             >
//               <span className="mr-3">{getIconComponent('AiOutlineCreditCard')}</span>
//               <span>Account</span>
//             </NavLink>
//           </div>
//         </li>

//         {/* Report Menu Item (Admin only) */}
...
//                 }
//               >
//                 <span className="mr-3">{getIconComponent('AiOutlineFileText')}</span>
//                 <span>Users</span>
//               </NavLink>
//             </div>
//           </li>
        ...
        {role === 'trader' && (
          <li>
            ...
            >
              ...
              >
                <span className="mr-3">{getIconComponent('BsReceiptCutoff')}</span>
                <span>UTR</span>
              </NavLink>
            </div>
          </li>
