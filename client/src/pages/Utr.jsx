...
//                 className="bg-purple-600 text-white p-2 flex items-center gap-2 rounded-[5px] hover:bg-purple-700 transition duration-200"
//               >
//                 <FaPlus size={13} />
          ...
          >
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="bg-green-600 text-white p-2 flex items-center gap-2 rounded-[5px] hover:bg-green-700 transition duration-200"
