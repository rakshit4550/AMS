...
//             <div className="">
//               <div>
//                 <label className="block text-sm font-medium mb-1 text-[#4c4b59]">Email</label>
...
//               </div>
//               <div>
//                 <label className="block text-sm font-medium mb-1 text-[#4c4b59]">Password</label>
//                 <div className="relative">
//                   <input
//                     type="password"
//                     value={password}
...
//               type="submit"
//               disabled={loading}
//               className="bg-[#424687] text-white px-10 py-3 my-3 rounded-md focus:outline-none focus:shadow-outline-blue w-full flex items-center justify-center">
      ...
      <div className="w-full lg:w-1/2 px-4 lg:pr-10 flex flex-col justify-center">
        ...
        <div className="flex items-center justify-center">
          <form onSubmit={handleSubmit} className="w-full max-w-md shadow-xl py-10 px-5 bg-white rounded border">
            ...
            <div className="">
              <div>
                <label className="block text-sm font-medium mb-1 text-[#4c4b59]">Username or Email</label>
                <div className="relative">
                  <input
                    type="text"
                    value={email}
