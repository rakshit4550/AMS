...
//     const response = await axios.get(`${API_URL}/me`, config); // Correct endpoint to /me
...
//       role: response.data.role,
//       id: response.data.id,
//       username: response.data.username, // Include username if available from backend
//       email: response.data.email, // Include email if available from backend
//     };
//   } catch (error) {
...
//         if (action.payload === 'No token found' || action.payload.includes('Invalid token')) {
//           state.token = null;
